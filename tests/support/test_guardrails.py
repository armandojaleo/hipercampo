...
import hipercampo.cycle.memory as M                         # noqa: E402
from hipercampo.cycle.memory import Hipercampo              # noqa: E402
from hipercampo.support.safety import redact_secrets          # noqa: E402
...
def test_redact_secrets_enmascara():
    ...
    assert "sk_live_ABCDEF123456" not in r and "redacted" in r
